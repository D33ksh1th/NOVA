...
from .speaker import SpeakerRecognizer, SpeakerRegistry, ResemblyzerSpeakerRecognizer
...
class VoiceComponentFactory:
    ...
    def create_speaker_recognizer(self, registry: SpeakerRegistry) -> SpeakerRecognizer:
        ...
        if "resemblyzer" in provider or "speechbrain" in provider:
            return ResemblyzerSpeakerRecognizer(
                registry=registry,
