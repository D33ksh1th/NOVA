...
from services.vision.face_identity import FaceIdentityService, FaceRegistry
...
class VisionTool(Tool):
    def __init__(self):
        ...
        self.face_identity = FaceIdentityService(
            registry=FaceRegistry(),
            similarity_threshold=settings.FACE_IDENTITY_THRESHOLD,
        )
