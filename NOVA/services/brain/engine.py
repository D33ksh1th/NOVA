...
from services.tools.apple_music import MUSIC_CHOICE_PROMPT
...
class BrainEngine:
    ...
    def process(self, message: str):
        ...
        context["music_choice_pending"] = self.conversation.last_nova_response() == MUSIC_CHOICE_PROMPT
        ...
        if self.skill_manager is not None:
            ...
            if skill_result is not None:
                ...
                if action_name not in {"filesystem", "system_info", "music_playback"}:
