    ...
    (set) => ({
      ...
      setVoice: (partial) =>
        set((s) => ({ voice: {
          ...s.voice,
          ...partial,
          ...(partial.model === "english_lessac" ? { accent: "english_jarvis" as AccentProfile } : {}),
          ...(partial.model === "english_amy" ? { accent: "english_friday" as AccentProfile } : {}),
        } })),
    ...
    }),
    {
      ...
      migrate: (persisted, _version) => {
        ...
        return {
          ...
          voice: {
            ...voice,
            model: voice.model === "english_amy" ? "english_amy" : "english_lessac",
            accent: (voice.model === "english_amy" ? "english_friday" : "english_jarvis") as AccentProfile,
          },
        };
      },
    }
